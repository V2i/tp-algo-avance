...
class Img {
   ...
   param : liste des coordonnées de pixels à mettre en blanc
    ...
    /**
     * resoud le problème DebruitImage sur this.
     * strategie : utilisez la <=S reduction entre DebruitImage et DebruitImageGraphe,
     * ainsi que la methode calculOpt() pour résoudre optimalement l'instance de DebruitImageGraphe créé
     */
    
     public Img resoudre(double alpha){
	//à compléter	
	return null;
    }
